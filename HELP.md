...
* The original package name 'com.mballem.curso.boot.demo-mvc' is invalid and this project uses 'com.mballem.curso.boot.demo_mvc' instead.
...
* [Thymeleaf](https://docs.spring.io/spring-boot/3.4.7/reference/web/servlet.html#web.servlet.spring-mvc.template-engines)
